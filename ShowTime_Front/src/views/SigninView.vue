<template>
  ...
  <div class="container">
    ...
    <div class="more">Need an account ?  Signup <router-link class="link" to="/login/signup"> here </router-link> </div>
...
export default {
  name: 'SigninView',
    methods: {
    submit() {      
      this.$store.dispatch('signin', {"email": this.$refs.email.value, "password": this.$refs.password.value})
    }
  },
}
</script>
...
.container input:focus {
  outline: solid 1.5px var(--green2);
}
