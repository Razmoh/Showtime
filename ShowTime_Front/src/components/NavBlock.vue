<template>
  ...
  <nav>
    ...
    <div class="flex">
      <router-link to="/admin/user" class="option admin" v-if="visible() == 'true'" >Administration</router-link>
      <div v-on:click="goProfile()" class="option profile" v-if="checkLogged()">Profile</div>
...
export default {
  ...
  methods: {
    ...
    goProfile() {
      ...
      // this.$router.push('/user/'+this.$store.getters.getUser)
    },
